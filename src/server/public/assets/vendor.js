    ...
    function(e, t, n) {
      ...
      function x(e) {
        ...
        var $ = {
          ...
          createHref: U,
          push: function(e, t) {
            var r = m(e, t, P(), $.location);
            O.confirmTransitionTo(r, 'PUSH', v, function(e) {
              if (e) {
                var t = U(r),
                  i = r.key,
                  a = r.state;
          ...
          replace: function(e, t) {
            var r = m(e, t, P(), $.location);
            O.confirmTransitionTo(r, 'REPLACE', v, function(e) {
              if (e) {
                var t = U(r),
                  i = r.key,
                  a = r.state;
      ...
      function _(e) {
        ...
        function L(e) {
          1 === (A += e) && 1 === e
            ...
            : 0 === A && window.removeEventListener(T, R);
        }
        var F = !1;
        var D = {
          length: t.length,
        ...
        return function(t) {
          ...
          function p(n) {
            ...
            return Object(r.useMemo)(
              function() {
                return h ? o.a.createElement(p.Provider, { value: M }, W) : W;
              },
              [p, W, M]
            );
          }
...
*/ var r =
    ...
    function(e, t, n) {
          ...
          extractEvents: function(e, t, n, r) {
            ...
            return (
              i
                ? (Cr &&
                    'ko' !== n.locale &&
                    (Mr || i !== Or.compositionStart
                      ? i === Or.compositionEnd && Mr && (o = br())
      ...
      function qr(e, t, n) {
        'focus' === e
          ? (Br(), (Fr = n), (Lr = t).attachEvent('onpropertychange', Hr))
          : 'blur' === e && Br();
      }
      function Kr(e) {
      ...
      function Go(e) {
        return null === Wo ? ((Wo = [e]), (Vo = _o(Io, Zo))) : Wo.push(e), Do;
      }
      function Jo() {
        if (null !== Vo) {
          var e = Vo;
      ...
      function Zo() {
        if (!Bo && null !== Wo) {
          ...
          try {
            ...
            throw (null !== Wo && (Wo = Wo.slice(e + 1)), _o(Io, Jo), t);
          } finally {
            Bo = !1;
          }
        }
      ...
      function Ui(e) {
        ...
        function p(e, t, n, r) {
          ...
          if ('object' == typeof n && null !== n) {
            ...
            if (ji(n) || X(n)) return null !== o ? null : f(e, t, n, r, null);
            Ii(e, n);
          }
          return null;
        }
        function h(e, t, n, r, o) {
          ...
          if ('object' == typeof r && null !== r) {
            ...
            if (ji(r) || X(r)) return f(t, (e = e.get(n) || null), r, o, null);
            Ii(t, r);
          }
          return null;
        }
      ...
      function yu(e, t) {
        ...
        return (
          null !== o && (Hl === o && (Ou(t), Ql === Wl && tc(o, Kl)), nc(o, t)),
          o
        );
      }
      function gu(e) {
      ...
      function wu(e, t) {
        ...
        var n = gu(e);
        if (0 !== n) {
          if (((t = e.callbackNode), (Bl & (Ul | Al)) !== zl))
            throw Error(a(327));
          if ((Au(), (e === Hl && n === Kl) || Tu(e, n), null !== ql)) {
            var r = Bl;
            Bl |= Ul;
            for (var o = Cu(); ; )
              try {
      ...
      function ku(e) {
        ...
        if (((t = 0 !== t ? t : 1073741823), e.finishedExpirationTime === t))
          ...
          if ((Bl & (Ul | Al)) !== zl) throw Error(a(327));
          if ((Au(), (e === Hl && t === Kl) || Tu(e, t), null !== ql)) {
            var n = Bl;
            Bl |= Ul;
            for (var r = Cu(); ; )
              try {
      ...
      function Iu(e, t) {
        if ((Au(), (Bl & (Ul | Al)) !== zl)) throw Error(a(327));
      ...
      function Lu() {
        if (null === uu) return !1;
        var e = uu;
        if (((uu = null), (Bl & (Ul | Al)) !== zl)) throw Error(a(331));
        var t = Bl;
      ...
      var dc,
        ...
        hc = {
          ...
          flushSync: function(e, t) {
            if ((Bl & (Ul | Al)) !== zl) throw Error(a(187));
            var n = Bl;
            Bl |= 1;
            try {
        ...
        try {
          for (
            ...
            if (null !== l) {
              ...
              (n = t.unstable_now()),
                'function' == typeof u ? (j.callback = u) : j === P(N) && O(N),
                L(n);
            } else O(N);
            j = P(N);
          }
            ...
            u > l
              ? ((e.sortIndex = u),
                ...
                null === P(N) &&
                  e === P(R) &&
                  (A ? i() : (A = !0), o(F, u - l)))
              : ((e.sortIndex = a), C(N, e), U || I || ((U = !0), r(D))),
            e
          );
        }),
